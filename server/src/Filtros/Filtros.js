...
class Filtros {
  ...
  CountPositiveOpinionForEachCategory(comentarios) {
    let count = {
      'count_comida': 0,
      'count_bebida': 0,
      'count_servico': 0,
    ...
    for (const comentario of comentarios) {
      for(const opinion of comentario.opinions){
        if (opinion.category === 'bebida' && opinion.teor=== 'positive') 
         count.count_bebida += 1
        else if (opinion.category === 'comida' && opinion.teor=== 'positive')
         count.count_comida += 1
        else if (opinion.category === 'servico' && opinion.teor=== 'positive') 
         count.count_servico += 1
        else if (opinion.category === 'preco' && opinion.teor=== 'positive') 
         count.count_preco += 1
        else if (opinion.category === 'ambiente' && opinion.teor=== 'positive') 
         count.count_ambiente += 1
        else if (opinion.category === 'localizacao' && opinion.teor=== 'positive') 
          count.count_localizacao += 1
        else (opinion.category === 'outros' && opinion.teor=== 'positive') 
          count.count_outros += 1
      }
    }
    return count;
  }
  ...
  CountNegativeOpinionForEachCategory(comentarios) {
    let count = {
      'count_comida': 0,
      'count_bebida': 0,
      'count_servico': 0,
    ...
    for (const comentario of comentarios) {
      for(const opinion of comentario.opinions){
        if (opinion.category === 'bebida' && opinion.teor=== 'negative') 
         count.count_bebida += 1
        else if (opinion.category === 'comida' && opinion.teor=== 'negative')
         count.count_comida += 1
        else if (opinion.category === 'servico' && opinion.teor=== 'negative') 
         count.count_servico += 1
        else if (opinion.category === 'preco' && opinion.teor=== 'negative') 
         count.count_preco += 1
        else if (opinion.category === 'ambiente' && opinion.teor=== 'negative') 
         count.count_ambiente += 1
        else if (opinion.category === 'localizacao' && opinion.teor=== 'negative') 
          count.count_localizacao += 1
        else (opinion.category === 'outros' && opinion.teor=== 'negative') 
          count.count_outros += 1
      }
    }
    return count;
  ...
  CountSitesEspecializados(opinions) {
    ...
    CountPercentForEachPlataforma(opinions){
      ...
      return {
        'twitter': this.round(twitter,2).toFixed(2), 
        'instagram': this.round(instagram,2).toFixed(2), 
        'facebook':this.round(facebook,2).toFixed(2), 
        'yelp': this.round(yelp,2).toFixed(2), 
        'googlereviews': this.round(googlereviews,2).toFixed(2), 
        'tripadvisor':this.round(tripadvisor,2).toFixed(2), 
        'web': this.round(web,2).toFixed(2)
      }
    }
...
var end = moment(interval_fim);
  ...
  FormatToChartFree_Comparacao (opinions_by_cronology, opinions_by_cronology_concorrente,interval_init, interval_fim){
    ...
    //('tendi')
    //(opinions_by_cronology_concorrente)
    let splited_obj = ''
    let splited_obj2 = ''
    let label = ''
